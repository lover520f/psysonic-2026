...
export function PlaylistSmartCoverCell({ coverId, serverId }: { coverId: string; serverId?: string }) {
  return (
    <AlbumCoverArtImage
      albumId={coverId}
      coverArt={coverId}
...
export function PlaylistCardMainCover({ coverArt, alt, serverId }: { coverArt: string; alt: string; serverId?: string }) {
  return (
    <AlbumCoverArtImage
      albumId={coverArt}
      coverArt={coverArt}
