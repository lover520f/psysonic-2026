export const settings = {
  ...
  useServer: 'Folosește',
  deleteServer: 'Șterge',
  deleteServerInCluster: 'Elimină mai întâi serverul din cluster',
  clustersTitle: 'Clustere de servere',
  clustersHint: 'Combină biblioteci de pe mai multe servere. Trage membrii pentru prioritate (primul = preferat).',
  clusterActive: 'Cluster activ',
  useCluster: 'Folosește',
  clusterCreate: 'Creează cluster',
  clusterAdd: 'Adaugă cluster',
  clusterNamePlaceholder: 'Nume cluster',
  clusterRemoveMember: 'Elimină',
  clusterSyncPlayCounts: 'Sincronizează numărul de redări între membri',
  clusterSyncPlayCountsWarn: 'Numărul de redări va fi scris pe toți membrii clusterului când e activat.',
