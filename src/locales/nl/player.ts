export const player = {
  ...
  playbackErrorSkipping: 'Nummer kon niet worden afgespeeld - wordt overgeslagen. {{detail}}',
  playbackAlternativePrompt: 'Deze bron kon niet worden afgespeeld. Kies een andere server om opnieuw te proberen.',
  playbackAlternativeTitle: 'Afspeelbron kiezen',
  playbackAlternativeDescription: 'De wachtrij blijft ongewijzigd totdat je expliciet een overeenkomende bron kiest.',
  playbackAlternativeLoading: 'Bereikbare of gedownloade alternatieven zoeken...',
  playbackAlternativeNone: 'Er is geen andere bereikbare of gedownloade bron voor dit nummer.',
  playbackAlternativeResolveError: 'Alternatieven konden niet worden geladen. Sluit dit venster om het huidige item te behouden.',
  playbackAlternativePlayFrom: 'Afspelen vanaf {{server}}',
  playbackAlternativeLocal: 'Gedownload',
  playbackAlternativeClose: 'Keuze voor afspeelbron sluiten',
  playbackAlternativeStale: 'De wachtrij is gewijzigd vóór de keuze. Er is niets vervangen.',
  playbackAlternativeUnavailable: 'Deze afspeelbron is niet meer beschikbaar.',
};
