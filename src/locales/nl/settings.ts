export const settings = {
  ...
  deleteServerInCluster: 'Verwijder deze server eerst uit de cluster',
  clustersTitle: 'Serverclusters',
  clustersHint: 'Bibliotheken van meerdere servers samenvoegen. Sleep leden om prioriteit in te stellen (eerste = voorkeur).',
  clusterActive: 'Actieve cluster',
  useCluster: 'Gebruiken',
  clusterCreate: 'Cluster maken',
  clusterAdd: 'Cluster toevoegen',
  clusterNamePlaceholder: 'Clusternaam',
  clusterRemoveMember: 'Verwijderen',
  clusterSyncPlayCounts: 'Afspeeltellers synchroniseren tussen leden',
  clusterSyncPlayCountsWarn: 'Afspeeltellers worden naar alle clusterleden geschreven wanneer ingeschakeld.',
