export const settings = {
  ...
  useServer: 'Use',
  deleteServer: 'Delete',
  deleteServerInCluster: 'Remove this server from its cluster first',
  clustersTitle: 'Server clusters',
  clustersHint: 'Merge libraries from multiple servers. Drag members to set priority (first = preferred).',
  clusterActive: 'Active cluster',
  useCluster: 'Use',
  clusterCreate: 'Create cluster',
  clusterAdd: 'Add cluster',
  clusterNamePlaceholder: 'Cluster name',
  clusterRemoveMember: 'Remove',
  clusterSyncPlayCounts: 'Sync play counts across members',
  clusterSyncPlayCountsWarn: 'Play counts will be written to all cluster members when enabled.',
