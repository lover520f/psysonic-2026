export const playlists = {
  ...
  smartMembershipReadOnly: 'This smart playlist is generated by {{server}}. Add, remove, reorder, and CSV import are disabled here so its server rules are not replaced.',
