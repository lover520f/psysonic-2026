export const playlists = {
  ...
  smartMembershipReadOnly: 'Esta lista inteligente la genera {{server}}. Añadir, eliminar, reordenar e importar CSV están desactivados aquí para no sustituir sus reglas del servidor.',
