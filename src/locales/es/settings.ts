export const settings = {
  ...
  themeStoreOptInTitle: 'Tienda de temas y estadísticas globales',
  themeStoreOptInDesc: 'Explora el catálogo de temas en línea y consulta el número de instalaciones y las valoraciones globales.',
  themeStoreOptInPrivacy: 'Desactivada de forma predeterminada. Cuando está activada, la aplicación carga el catálogo y las estadísticas desde el servicio de temas de Psysonic y, de forma anónima y sin cuenta, informa de los temas que instalas y valoras. Mientras está desactivada, no se envía ningún dato y solo están disponibles tus temas integrados e instalados.',
  ...
  themeStoreSortDownloads: 'Más descargas',
  themeStoreSortRated: 'Mejor valorados',
  themeStoreSortNewest: 'Más recientes',
  themeStoreSortName: 'Alfabético',
  themeStoreAuthor: 'Autor',
  themeStoreRating: 'Valoración',
  themeStoreDownloads: 'Descargas totales',
  themeStoreYourRating: 'Tu valoración',
  themeStoreRatingCount: '{{count}} valoraciones',
  themeStoreNoRatings: 'Sin valoraciones todavía',
