export const settings = {
  ...
  deleteServerInCluster: 'Quita este servidor del cluster primero',
  clustersTitle: 'Clusters de servidores',
  clustersHint: 'Fusiona bibliotecas de varios servidores. Arrastra miembros para establecer prioridad (el primero = preferido).',
  clusterActive: 'Cluster activo',
  useCluster: 'Usar',
  clusterCreate: 'Crear cluster',
  clusterAdd: 'Añadir cluster',
  clusterNamePlaceholder: 'Nombre del cluster',
  clusterRemoveMember: 'Quitar',
  clusterSyncPlayCounts: 'Sincronizar reproducciones entre miembros',
  clusterSyncPlayCountsWarn: 'Las reproducciones se escribirán en todos los miembros del cluster si está activado.',
