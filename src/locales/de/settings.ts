export const settings = {
  ...
  deleteServerInCluster: 'Server zuerst aus dem Cluster entfernen',
  clustersTitle: 'Server-Cluster',
  clustersHint: 'Bibliotheken mehrerer Server zusammenführen. Mit Drag & Drop die Priorität festlegen (oben = bevorzugt).',
  clusterActive: 'Aktiver Cluster',
  useCluster: 'Verwenden',
  clusterCreate: 'Cluster erstellen',
  clusterAdd: 'Cluster hinzufügen',
  clusterNamePlaceholder: 'Clustername',
  clusterRemoveMember: 'Entfernen',
  clusterSyncPlayCounts: 'Wiedergabezähler über Mitglieder synchronisieren',
  clusterSyncPlayCountsWarn: 'Wiedergabezähler werden bei Aktivierung an alle Cluster-Mitglieder geschrieben.',
