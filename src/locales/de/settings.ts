export const settings = {
  ...
  themeStoreOptInTitle: 'Theme-Store & globale Statistiken',
  themeStoreOptInDesc: 'Durchstöbere den Online-Theme-Katalog und sieh dir globale Installationszahlen und Bewertungen an.',
  themeStoreOptInPrivacy: 'Standardmäßig deaktiviert. Wenn aktiviert, lädt die App den Katalog und die Statistiken vom Psysonic-Theme-Dienst und meldet — anonym und ohne Konto — die Themes, die du installierst und bewertest. Solange deaktiviert, werden keine Daten gesendet und nur deine integrierten und installierten Themes sind verfügbar.',
  ...
  themeStoreSortDownloads: 'Meiste Downloads',
  themeStoreSortRated: 'Höchst Bewertet',
  themeStoreSortNewest: 'Neueste',
  themeStoreSortName: 'Alphabetisch',
  themeStoreAuthor: 'Autor',
  themeStoreRating: 'Bewertung',
  themeStoreDownloads: 'Downloads gesamt',
  themeStoreYourRating: 'Deine Bewertung',
  themeStoreRatingCount: '{{count}} Bewertungen',
  themeStoreNoRatings: 'Noch nicht bewertet',
