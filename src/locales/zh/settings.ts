export const settings = {
  ...
  useServer: '使用',
  deleteServer: '删除',
  deleteServerInCluster: '请先从集群中移除此服务器',
  clustersTitle: '服务器集群',
  clustersHint: '合并多个服务器的音乐库。拖动成员以设置优先级（第一个 = 首选）。',
  clusterActive: '当前集群',
  useCluster: '使用',
  clusterCreate: '创建集群',
  clusterAdd: '添加集群',
  clusterNamePlaceholder: '集群名称',
  clusterRemoveMember: '移除',
  clusterSyncPlayCounts: '在成员间同步播放次数',
  clusterSyncPlayCountsWarn: '启用后，播放次数将写入所有集群成员。',
  noServers: '未保存任何服务器。',
  serverActive: '当前使用',
