export const settings = {
  ...
  themeStoreOptInTitle: '主题商店与全局统计',
  themeStoreOptInDesc: '浏览在线主题目录，查看全局安装量和评分。',
  themeStoreOptInPrivacy: '默认关闭。开启后，应用会从 Psysonic 主题服务加载目录和统计数据，并以匿名方式（无需账号）上报你安装和评分的主题。关闭时不会发送任何数据，仅可使用内置主题和已安装的主题。',
  ...
  themeStoreSortDownloads: '下载最多',
  themeStoreSortRated: '评分最高',
  themeStoreSortNewest: '最新',
  themeStoreSortName: '按字母',
  themeStoreAuthor: '作者',
  themeStoreRating: '评分',
  themeStoreDownloads: '总下载量',
  themeStoreYourRating: '你的评分',
  themeStoreRatingCount: '{{count}} 条评分',
  themeStoreNoRatings: '暂无评分',
