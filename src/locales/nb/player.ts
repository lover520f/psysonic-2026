export const player = {
  ...
  playbackErrorSkipping: 'Kunne ikke spille av sporet - hopper over. {{detail}}',
  playbackAlternativePrompt: 'Kunne ikke spille av denne kilden. Velg en annen server for å prøve igjen.',
  playbackAlternativeTitle: 'Velg avspillingskilde',
  playbackAlternativeDescription: 'Køen forblir uendret til du uttrykkelig velger en samsvarende kilde.',
  playbackAlternativeLoading: 'Leter etter tilgjengelige eller nedlastede alternativer...',
  playbackAlternativeNone: 'Ingen annen tilgjengelig eller nedlastet kilde finnes for dette sporet.',
  playbackAlternativeResolveError: 'Alternativene kunne ikke lastes. Lukk dialogen for å beholde gjeldende køelement.',
  playbackAlternativePlayFrom: 'Spill fra {{server}}',
  playbackAlternativeLocal: 'Nedlastet',
  playbackAlternativeClose: 'Lukk valg av avspillingskilde',
  playbackAlternativeStale: 'Køen ble endret før kilden ble valgt. Ingenting ble erstattet.',
  playbackAlternativeUnavailable: 'Denne avspillingskilden er ikke lenger tilgjengelig.',
};
