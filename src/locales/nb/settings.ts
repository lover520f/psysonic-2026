export const settings = {
  ...
  themeStoreOptInTitle: 'Temabutikk og global statistikk',
  themeStoreOptInDesc: 'Bla i den nettbaserte temakatalogen og se globale installasjonstall og vurderinger.',
  themeStoreOptInPrivacy: 'Av som standard. Når den er på, laster appen katalogen og statistikken fra Psysonic-tematjenesten og rapporterer — anonymt, uten konto — hvilke temaer du installerer og vurderer. Når den er av, sendes ingen data, og bare dine innebygde og installerte temaer er tilgjengelige.',
  ...
  themeStoreSortDownloads: 'Flest nedlastinger',
  themeStoreSortRated: 'Best vurdert',
  themeStoreSortNewest: 'Nyeste',
  themeStoreSortName: 'Alfabetisk',
  themeStoreAuthor: 'Forfatter',
  themeStoreRating: 'Vurdering',
  themeStoreDownloads: 'Totalt nedlastinger',
  themeStoreYourRating: 'Vurderingen din',
  themeStoreRatingCount: '{{count}} vurderinger',
  themeStoreNoRatings: 'Ikke vurdert ennå',
