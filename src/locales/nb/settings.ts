export const settings = {
  ...
  useServer: 'Bruk',
  deleteServer: 'Slett',
  deleteServerInCluster: 'Fjern serveren fra clusteret først',
  clustersTitle: 'Serverklynger',
  clustersHint: 'Slå sammen biblioteker fra flere servere. Dra medlemmer for å sette prioritet (først = foretrukket).',
  clusterActive: 'Aktiv klynge',
  useCluster: 'Bruk',
  clusterCreate: 'Opprett klynge',
  clusterAdd: 'Legg til klynge',
  clusterNamePlaceholder: 'Klyngenavn',
  clusterRemoveMember: 'Fjern',
  clusterSyncPlayCounts: 'Synkroniser avspillingstall på tvers av medlemmer',
  clusterSyncPlayCountsWarn: 'Avspillingstall skrives til alle klynge-medlemmer når aktivert.',
