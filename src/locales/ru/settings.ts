export const settings = {
  ...
  deleteServerInCluster: 'Сначала удалите сервер из кластера',
  clustersTitle: 'Кластеры серверов',
  clustersHint: 'Объединение библиотек нескольких серверов. Перетаскивайте участников для приоритета (первый = предпочтительный).',
  clusterActive: 'Активный кластер',
  useCluster: 'Использовать',
  clusterCreate: 'Создать кластер',
  clusterAdd: 'Добавить кластер',
  clusterNamePlaceholder: 'Имя кластера',
  clusterRemoveMember: 'Убрать',
  clusterSyncPlayCounts: 'Синхронизировать счётчики прослушиваний между участниками',
  clusterSyncPlayCountsWarn: 'При включении счётчики будут записываться на все серверы кластера.',
