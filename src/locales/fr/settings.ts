export const settings = {
  ...
  deleteServerInCluster: 'Retirez d\'abord ce serveur de son cluster',
  clustersTitle: 'Clusters de serveurs',
  clustersHint: 'Fusionner les bibliothèques de plusieurs serveurs. Glissez les membres pour définir la priorité (le premier = préféré).',
  clusterActive: 'Cluster actif',
  useCluster: 'Utiliser',
  clusterCreate: 'Créer un cluster',
  clusterAdd: 'Ajouter un cluster',
  clusterNamePlaceholder: 'Nom du cluster',
  clusterRemoveMember: 'Retirer',
  clusterSyncPlayCounts: 'Synchroniser les compteurs de lecture entre membres',
  clusterSyncPlayCountsWarn: 'Les compteurs seront écrits sur tous les membres du cluster si activé.',
